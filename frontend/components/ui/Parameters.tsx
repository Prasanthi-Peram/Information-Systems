...
const chartData = [
  { date: "2024-04-01", desktop: 222, mobile: 150, power: 1.95 },
  { date: "2024-04-02", desktop: 97, mobile: 180, power: 1.75 },
  ...
  { date: "2024-06-30", desktop: 446, mobile: 400, power: 2.4 },
]
...
export function ChartAreaInteractive() {
  ...
  const [parameter, setParameter] = React.useState<"desktop" | "mobile" | "power">("desktop")
    ...
    <Card className="pt-0 flex flex-col h-full">
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        ...
        <div className="flex gap-2">
          <Select value={parameter} onValueChange={(value) => setParameter(value as "desktop" | "mobile" | "power")}>
            <SelectTrigger
